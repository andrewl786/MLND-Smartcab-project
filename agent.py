...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5, maxQ=0.0, counter=0.0):
    ...
    def get_maxQ(self, state):
        ...
        ''''for action in self.valid_actions:
            ...
            if actionvalue > self.maxQ:
                self.maxQ = actionvalue
...
def run():
    ...
    #   display      - set to False to disable the GUI if PyGame is enable
